...
## 1. Test Coverage
- **Requirement:** Maintain code coverage above **80%**.
- **Action:** Run tests after every significant code change.

## 2. Version Control
- **Strategy:** **Manual Commits Only**.
- **Rule:** The user will handle all `git commit` operations. The assistant MUST NOT commit changes automatically.
- **Task Summaries:** Use **Git Notes** (or manual logs) to track task completion if desired, but prioritize user control.

## 3. Task Execution
- **Step 1:** Understand the requirements.
- **Step 2:** Write/Update tests (TDD).
- **Step 3:** Implement the feature/fix.
- **Step 4:** Verify with tests.
- **Step 5:** Await user confirmation/action for version control.
