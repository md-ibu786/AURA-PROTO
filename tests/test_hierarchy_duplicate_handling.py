"""
============================================================================
FILE: test_hierarchy_duplicate_handling.py
LOCATION: tests/test_hierarchy_duplicate_handling.py
============================================================================
...
ROLE IN PROJECT:
    Validates utility functions for generating next available numbers and codes
    when creating hierarchical entities (departments, semesters, subjects, modules).
    - Tests get_next_available_number for sequential numbering
    - Tests get_next_available_code for code generation
    - Covers edge cases like gaps, empty lists, and negative numbers

KEY COMPONENTS:
    - TestGetNextAvailableNumber: Unit tests for number generation
    - TestGetNextAvailableCode: Unit tests for code generation
    - Edge case handling (gaps, negatives, empty lists)

DEPENDENCIES:
    - External: pytest
    - Internal: api.hierarchy_crud (get_next_available_number, get_next_available_code)

USAGE:
    Run with: pytest tests/test_hierarchy_duplicate_handling.py -v
============================================================================
"""
...
class TestGetNextAvailableCode:
    ...
    def test_mixed_prefixes(self):
        ...
        assert (
            get_next_available_code(["SUBJ001", "OTHER002", "SUBJ003"], "SUBJ")
            == "SUBJ004"
        )
