...
// Direct backend URL (port 8001) - uses APIRequestContext which needs backend access
// The frontend config uses port 5174 with dev server, but API tests need direct backend access
