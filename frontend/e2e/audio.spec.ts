 ...
 * ============================================================================
 * FILE: audio.spec.ts
 * LOCATION: frontend/e2e/audio.spec.ts
 * ============================================================================
 *
 * PURPOSE:
 ...
 *    - Internal: ApiHelper, ExplorerPage (page objects), fixtures
 *
 * USAGE:
 *    Run all audio tests: npx playwright test e2e/audio.spec.ts
...
test.describe('Audio Processing - Error Handling', () => {
    ...
    test('Rejects invalid file type', async ({ request }) => {
        ...
        const response = await request.post('/api/audio/upload-document', {
            multipart: {
                file: {
                    name: 'test.txt',
                    mimeType: 'text/plain',
